...
import '../providers/security_key_provider.dart';
...
abstract final class Dependencies {
  ...
  static List<SingleChildWidget> get _sharedProviders => [
    ...
    ChangeNotifierProvider(lazy: true, create: (context) => ApplicationProvider(applicationUseCase: context.read())),
    ChangeNotifierProvider(lazy: true, create: (context) => SecurityKeyProvider(securityKeyUseCase: context.read())),
    ChangeNotifierProvider(lazy: true, create: (context) => NotificationProvider(awesomeNotifications: context.read())),
    ChangeNotifierProvider(lazy: true, create: (context) => MoodProvider(moodDataUseCase: context.read())),
    ChangeNotifierProvider(lazy: true, create: (context) => StatisticProvider(statisticUseCase: context.read())),
  ];
