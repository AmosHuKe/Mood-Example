        ...
        onPressed: () {
          ...
          GoRouter.of(context).pushNamed(
            ...
            pathParameters: {
              ...
              'selectDateTime': moodProvider.selectDateTime.toString(),
            },
          );
        },
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScrollView(
      ...
      slivers: [
        ...
        /// 心情数据列表
        Selector<MoodProvider, ({bool moodDataListLoading, List<MoodDataModel> moodDataList})>(
          selector: (_, moodProvider) {
            return (
              moodDataListLoading: moodProvider.moodDataListLoading,
              moodDataList: moodProvider.moodDataList,
            );
          },
      ...
      child: DecoratedBox(
        ...
        child: Padding(
          ...
          child:
              ...
              >(
                selector: (BuildContext, moodProvider) {
                  return (
                    selectDateTime: moodProvider.selectDateTime,
                    moodRecordDateAllList: moodProvider.moodRecordDateAllList,
                  );
                },
                builder: (context, data, child) {
                  /// 当前选中的日期
                  ...
                  return TableCalendar(
                    ...
                    onDaySelected: (selectedDay, focusedDay) {
                      ...
                      /// 赋值当前选择的日期
                      moodProvider.selectDateTime = selectedDay;
                        ...
                        child: CupertinoAlertDialog(
                          ...
                          actions: <CupertinoDialogAction>[
                            ...
                            .new(
                              ...
                              onPressed: () async {
                                final moodProvider = context.read<MoodProvider>();
                                final result = await moodProvider.deleteMoodData(moodData.mood_id!);
                                switch (result) {
                                  case Success<bool>():
                                    if (result.value) {
                                      context.pop();
