...
import '../../../shared/utils/intl_utils.dart';
import '../../../shared/utils/result.dart';
import '../../../shared/utils/utils.dart';
import '../../../widgets/action_button/action_button.dart';
import '../providers/mood_category_select_provider.dart';
import '../providers/mood_content_edit_provider.dart';
...
class MoodContentEditScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => MoodContentEditProvider(moodData: moodData),
      child: Consumer<MoodContentEditProvider>(
        builder: (context, moodContentEditProvider, child) {
          final moodData = moodContentEditProvider.moodData;
          return Scaffold(
            appBar: AppBar(
              elevation: 0,
                  ...
                  child: ActionButton(
                    ...
                    onTap: () async {
                      ...
                      if (moodData.mood_id != null) {
                        /// 修改心情数据
                        /// 赋值修改时间
                        moodContentEditProvider.moodData = moodData.copyWith(
                          update_time: Utils.datetimeFormatToString(DateTime.now()),
                        );
                        result = await moodProvider.editMoodData(moodData);
                      } else {
                        /// 创建心情数据
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              Consumer<MoodContentEditProvider>(
                builder: (context, moodContentEditProvider, child) {
                  final moodData = moodContentEditProvider.moodData;
              ...
              Consumer<MoodContentEditProvider>(
                builder: (context, moodContentEditProvider, child) {
                  ...
                  return TextFormField(
                    ...
                    onChanged: (value) {
                      moodContentEditProvider.moodData = moodData.copyWith(content: value);
                    },
                  );
                },
              ),
...
class MoodScore extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<MoodContentEditProvider>(
      builder: (context, moodContentEditProvider, child) {
        final moodData = moodContentEditProvider.moodData;
        ...
        return Column(
          children: [
            ...
            Slider(
              ...
              onChanged: (value) {
                moodContentEditProvider.moodData = moodData.copyWith(score: value ~/ 1);
              },
            ),
          ],
        );
