...
class MoodCategorySelectScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) {
        return MoodCategorySelectProvider(
      ...
      children: [
        ...
        Padding(
          ...
          child:
              ...
              >(
                selector: (_, moodCategorySelectProvider) {
                  return (
                    screenType: moodCategorySelectProvider.screenType,
                    selectDateTime: moodCategorySelectProvider.selectDateTime,
                  );
                },
      ...
      child: Padding(
        ...
        child:
            ...
            >(
              selector: (_, moodCategorySelectProvider) {
                return (
                  loadMoodCategoryAllLoading: moodCategorySelectProvider.loadMoodCategoryAllLoading,
                  moodCategoryAll: moodCategorySelectProvider.moodCategoryAll,
                );
              },
  ...
  Widget build(BuildContext context) {
    ...
    >(
      selector: (_, moodCategorySelectProvider) {
        return (
          screenType: moodCategorySelectProvider.screenType,
          selectDateTimeToString: moodCategorySelectProvider.selectDateTimeToString,
        );
      },
      builder: (context, data, child) {
        final screenType = data.screenType;
