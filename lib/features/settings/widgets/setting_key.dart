...
class _KeyBodyState extends State<KeyBody> {
  ...
  Future<void> init(BuildContext context) async {
    ...
    /// 获取-安全-生物特征识别是否开启
    await securityKeyProvider.loadKeyBiometric();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<SecurityKeyProvider, ({String keyPassword, bool keyBiometric})>(
      selector: (_, securityKeyProvider) {
        return (
          keyPassword: securityKeyProvider.keyPassword,
          keyBiometric: securityKeyProvider.keyBiometric,
        );
      },
                ...
                onChanged: (value) async {
                  ...
                  if (value) {
                    if (await localAuthUtils.localAuthBiometric(context)) {
                      securityKeyProvider.keyBiometric = value;
                    }
                  } else {
                    securityKeyProvider.keyBiometric = value;
                  }
                ...
                child: CupertinoSwitch(
                  ...
                  onChanged: (value) async {
                    ...
                    if (value) {
                      createLockScreen(
                        context,
                        (password) => securityKeyProvider.keyPassword = password,
                      );
                    } else {
                      securityKeyProvider.keyPassword = '';
                      securityKeyProvider.keyBiometric = false;
                    }
                  },
                ),
              ),
