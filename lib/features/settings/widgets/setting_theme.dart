...
class DarkThemeBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<ApplicationProvider, ({ThemeMode themeMode})>(
      selector: (_, applicationProvider) {
        return (themeMode: applicationProvider.themeMode);
      },
        ...
        return Wrap(
          ...
          children: [
            ThemeCard(
              ...
              onTap: () => applicationProvider.themeMode = .system,
            ),
            ThemeCard(
...
class MultipleThemeBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<ApplicationProvider, ({MultipleThemeMode multipleThemeMode})>(
      selector: (_, applicationProvider) {
        return (multipleThemeMode: applicationProvider.multipleThemeMode);
      },
      builder: (context, data, child) {
