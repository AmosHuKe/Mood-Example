...
class StatisticBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final statisticFilterDays = statisticProvider.statisticFilterDays;
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    Selector<StatisticProvider, ({int selectDays})>(
                      selector: (_, statisticProvider) {
                        return (selectDays: statisticProvider.selectDays);
                      },
                          ...
                          children: .generate(statisticFilterDays.length, (index) {
                            ...
                            return FilterButton(
                              ...
                              onTap: () {
                                ...
                                statisticProvider.selectDays = filterDays;
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Padding(
                  padding: listPadding,
                  child: Selector<StatisticProvider, ({int selectDays})>(
                    selector: (_, statisticProvider) {
                      return (selectDays: statisticProvider.selectDays);
                    },
                    builder: (context, data, child) {
...
class OverallStatistics extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      physics: const AlwaysScrollableScrollPhysics(parent: BouncingScrollPhysics()),
      child:
          Selector<StatisticProvider, ({int appUsageDays, int appMoodCount, int moodScoreAverage})>(
            selector: (_, statisticProvider) {
              return (
                appUsageDays: statisticProvider.appUsageDays,
                appMoodCount: statisticProvider.appMoodCount,
                moodScoreAverage: statisticProvider.moodScoreAverage,
              );
            },
            builder: (context, data, child) {
              return Wrap(
...
class StatisticMoodLine extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    >(
      selector: (_, statisticProvider) {
        return (
          selectDays: statisticProvider.selectDays,
          moodScoreAverageRecently: statisticProvider.moodScoreAverageRecently,
        );
      },
      builder: (context, data, child) {
        /// 获取数据 计算近日平均
...
class _StatisticCategoryMoodState extends State<StatisticCategoryMood> {
  ...
  @override
  Widget build(BuildContext context) {
    return Selector<StatisticProvider, ({List<StatisticMoodCountRecentlyModel> moodCountRecently})>(
      selector: (_, statisticProvider) {
        return (moodCountRecently: statisticProvider.moodCountRecently);
      },
      builder: (context, data, child) {
