...
///
import 'package:moodexample/theme/color_mode/theme_teal.dart';
import 'package:moodexample/theme/color_mode/theme_blue.dart';
...
class AppTheme {
  ...
  /// 主题颜色 light
  ThemeData themeLightColorMode() {
    ThemeData lightTheme = AppThemeBlue.lightTheme;
    switch (colorMode) {
      case "blue":
        lightTheme = AppThemeBlue.lightTheme;
        break;
      case "teal":
        lightTheme = AppThemeTeal.lightTheme;
        break;
      default:
        lightTheme = AppThemeBlue.lightTheme;
        break;
  ...
  /// 主题颜色 dark
  ThemeData themeDarkColorMode() {
    ThemeData darkTheme = AppThemeBlue.darkTheme;
    switch (colorMode) {
      case "blue":
        darkTheme = AppThemeBlue.darkTheme;
        break;
      case "teal":
        darkTheme = AppThemeTeal.darkTheme;
        break;
      default:
        darkTheme = AppThemeBlue.darkTheme;
        break;
