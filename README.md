...
<p align="center">
<a target="_blank" href="/CHANGELOG.md"><img alt="Mood-Example v1.4.3" src="https://img.shields.io/badge/Mood--Example-v1.4.3-3e4663"/></a> 
...
集成测试，使用模拟器集成测试应用，在 `test_driver/app.dart` 启动，  
启动测试后，运行测试套件 `test_driver/<name>_test.dart`，如 `test_driver/app_test.dart` 进行测试。  
或者使用指令：   
