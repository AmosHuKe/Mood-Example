...
<p align="center">
  ...
  <a href="https://flutter.dev/"><img alt="Flutter v3.35.4" src="https://img.shields.io/badge/Flutter-v3.35.4-0468D7"/></a> 
...
Windows:   
```
[√] Flutter (Channel stable, 3.35.4, on Microsoft Windows [版本 10.0.22621.3007], locale zh-CN)
...
macOS:   
```
[✓] Flutter (Channel stable, 3.35.4, on macOS 14.7 23H124 darwin-x64, locale zh-Hans-CN)
[✓] Android toolchain - develop for Android devices (Android SDK version 36.0.0)
